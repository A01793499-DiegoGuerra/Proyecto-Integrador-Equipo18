...
def interactive_view():
    ...
    precio_neto = st.number_input('Precio Neto', min_value=0.0, max_value=100.0, value=50.0)
    costo_neto = st.number_input('Costo Neto', min_value=0.0, max_value=100.0, value=30.0)
    precio_brent = st.number_input('Precio Brent', min_value=0.0, max_value=200.0, value=60.0)
